...
public class Answers {
     ...
     * @mbg.generated Mon Jun 25 17:14:39 CST 2018
     */
    @ApiModelProperty(value="单选题答案,格式为 第一题分数|第二题分数,eg: 5|4|3|2")
   ...
   @ApiModelProperty(value="简答题答案,格式为 第一题的答案|第二题的答案"
   		+ ",eg:java数据类型没听明白|老师语速太快")
   private String content;
     ...
     * @mbg.generated Mon Jun 25 17:14:39 CST 2018
     */
   @ApiModelProperty(value="问卷的编号 ,答卷的外键")
